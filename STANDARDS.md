...
| Agent interoperability          | [A2A 1.0 extensions](https://a2a-protocol.org/latest/topics/extensions/)                                                            | Advertise the versioned extension and protected preparation parameters, activate it with `A2A-Extensions`, authenticate outside message payloads, and retain only opaque references and redacted receipts in task history. |
